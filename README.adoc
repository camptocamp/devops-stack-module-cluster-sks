...
- [[provider_kubernetes]] <<provider_kubernetes,kubernetes>> (>= 2.21)
...
- https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/config_map_v1_data[kubernetes_config_map_v1_data.coredns_configmap_overload] (resource)
...
- https://registry.terraform.io/providers/hashicorp/null/latest/docs/resources/resource[null_resource.coredns_restart] (resource)
- https://registry.terraform.io/providers/exoscale/exoscale/latest/docs/data-sources/domain[exoscale_domain.this] (data source)
- https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/data-sources/config_map[kubernetes_config_map.coredns_configmap] (data source)
